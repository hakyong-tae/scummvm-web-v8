...
export const UI = {
  ko: {
    ...
    hintsTitle: '힌트', hintsIntro: '광고를 끝까지 보면 힌트를 볼 수 있습니다. 중간에 닫아도 불이익은 없습니다.', hintsWatch: '광고 보고 힌트 보기', hintsUnlocked: '이번 플레이 동안 힌트가 열렸습니다.', hintsNotRewarded: '광고를 끝까지 보지 않아 힌트가 열리지 않았습니다. 다시 시도할 수 있습니다.', close: '닫기',
    noticeTitle: '정보 / 라이선스',
  },
  en: {
    ...
    hintsTitle: 'Hints', hintsIntro: 'Watch an ad to the end to unlock hints. Closing early costs nothing.', hintsWatch: 'Watch ad for hints', hintsUnlocked: 'Hints are unlocked for this session.', hintsNotRewarded: 'The ad was not completed, so hints stay locked. You can try again.', close: 'Close',
